...
``` sh
storm jar target/stormcrawlertest-1.0-SNAPSHOT.jar com.cnf271.CrawlTopology -conf crawler-conf.yaml -local
```
...
``` sh
storm jar target/stormcrawlertest-1.0-SNAPSHOT.jar  org.apache.storm.flux.Flux --local crawler.flux --sleep 86400000
```
